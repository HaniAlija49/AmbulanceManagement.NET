Feature: Patient Management
  ...
  Scenario: Search for patients by name
    When I navigate to the "Patients" page
    And I search for a patient with the name "Uvejs"
    Then I should see a list of patients containing "Uvejs"
 ...
 Scenario: Create a new patient
  ...
  Scenario: View patient details
    Given a patient named "Muhamed Neziri" exists
    When I view the details of patient "Muhamed Neziri"
    Then I should see the reports linked to their appointments

  Scenario: Edit an existing patient's age
     Given a patient named "Hani Alija" exists
     When I update the age of "Hani Alija" to "40"
